                ...
                <div id="tab-seguimiento" class="tab-content hidden">
                    <div class="space-y-6">
                        ...
                        <?php else: ?>
                            ...
                            <?php $mensajeSeguimientoDefault = "Ya quedan pocos dias!!, recuerda completar tu registro y participar en la mesa logistica comercial mas importante del conosur. No te quedes fuera, ya son mas de 35 empresas que participaran de esta actividad. Completa tu registro ya!"; ?>
